...
export default function CartPage(){
    ...
    // const [cardLoaded, setCartLoaded] = useState(false);
        ...
        <div className="w-full h-[calc(100vh-100px)] bg-primary flex flex-col pt-[25px] items-center">
            <div className="w-[600px] flex flex-col gap-4">
                                ...
                                <div className="w-[180px] h-full flex flex-col">
                                    {
                                        ...
                                        <span className="text-secondary text-lg w-full text-right line-through pr-[10px] mt-[20px]">LKR {item.labelledPrice.toFixed(2)}</span>
                                    }
                ...
                <div className="w-full h-[100px] bg-white flex justify-end items-center relative">
                    <Link to="/checkout" className="absolute left-0 bg-accent text-white px-6 py-3 ml-[20px] hover:bg-accent/80">Proceed to Checkout</Link>
