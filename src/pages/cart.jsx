    ...
    return(
        <div className="w-full lg:h-[calc(100vh-100px)] bg-primary flex flex-col pt-[25px] items-center">
            <div className="w-[400px] lg:w-[600px] flex flex-col gap-4">
                                ...
                                <div className="w-full lg:w-[180px] lg:h-full items-center justify-center flex flex-row lg:flex-col">
                                    {
                                        ...
                                        <span className="text-secondary text-lg lg:w-full text-center lg:text-right line-through pr-[10px] lg:mt-[20px]">LKR {item.labelledPrice.toFixed(2)}</span>
                                    }
                ...
                <div className="w-full lg:w-full h-[100px] bg-white flex flex-col-reverse lg:flex-row justify-end items-center relative">
